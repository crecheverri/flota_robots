...
"""autogenerated by genpy from nebulizador_arm/JointMove_actionAction.msg. Do not edit."""
import codecs
import sys
...
import genpy
import nebulizador_arm.msg
import std_msgs.msg

class JointMove_actionAction(genpy.Message):
  _md5sum = "850bc8fa29657471770acf9ea3314a15"
  _type = "nebulizador_arm/JointMove_actionAction"
...
"""
  ...
  _slot_types = ['nebulizador_arm/JointMove_actionActionGoal','nebulizador_arm/JointMove_actionActionResult','nebulizador_arm/JointMove_actionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointMove_actionAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = nebulizador_arm.msg.JointMove_actionActionGoal()
      if self.action_result is None:
        self.action_result = nebulizador_arm.msg.JointMove_actionActionResult()
      if self.action_feedback is None:
        self.action_feedback = nebulizador_arm.msg.JointMove_actionActionFeedback()
    else:
      self.action_goal = nebulizador_arm.msg.JointMove_actionActionGoal()
      self.action_result = nebulizador_arm.msg.JointMove_actionActionResult()
      self.action_feedback = nebulizador_arm.msg.JointMove_actionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.count
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_f3I().pack(_x.action_result.result.final_count, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.count,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.final_count, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.current_number,) = _get_struct_f().unpack(str[start:end])
      return self
